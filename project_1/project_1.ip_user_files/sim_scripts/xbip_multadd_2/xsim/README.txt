...
#
# Generated by export_simulation on Tue Nov 12 16:32:22 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './xbip_multadd_2.sh' script.

./xbip_multadd_2.sh -reset_run
...
./xbip_multadd_2.sh -noclean_files

For more information on the script, please type './xbip_multadd_2.sh -help'.
