...
#
# Generated by export_simulation on Tue Nov 12 16:31:40 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './mult_sfix16.sh' script.

./mult_sfix16.sh -reset_run
...
./mult_sfix16.sh -noclean_files

For more information on the script, please type './mult_sfix16.sh -help'.
