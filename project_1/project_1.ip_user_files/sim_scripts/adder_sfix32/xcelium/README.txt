...
#
# Generated by export_simulation on Tue Nov 12 16:26:22 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './adder_sfix32.sh' script.

./adder_sfix32.sh -reset_run
...
./adder_sfix32.sh -noclean_files

For more information on the script, please type './adder_sfix32.sh -help'.
