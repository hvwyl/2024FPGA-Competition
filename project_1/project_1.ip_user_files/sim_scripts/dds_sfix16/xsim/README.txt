...
#
# Generated by export_simulation on Tue Nov 12 16:28:24 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './dds_sfix16.sh' script.

./dds_sfix16.sh -reset_run
...
./dds_sfix16.sh -noclean_files

For more information on the script, please type './dds_sfix16.sh -help'.
